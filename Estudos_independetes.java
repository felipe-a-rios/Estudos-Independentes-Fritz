    ...
    do {
      ...
      switch (i) {
        ...
        case (2):
          int Ped = 0;
          do {
            Ped = Entrada.leiaInt(menuJanela("PEDIDOS")
                + "Digite a opção que você quer acessar \n1- Cadastro de Pedidos \n2- Relatório Pedidos \n3- Voltar a tela inicial");
            switch (Ped) {
              case (1):
                ...
                while (continuarPedido == 1) {
                  ...
                  while (linha != null) {
                    // O .split(";") fatia a linha inteira de forma automatica em um vetor!
                    // Estrutura cadastrada: [0]=id; [1]=nome; [2]=grupo; [3]=estoque; [4]=preco;
                    // [5]=nome_sis
                  ...
                  if (!produtoExiste) {
                    ...
                    while (linha != null) {
                      ...
                      // Remonta a linha respeitando fielmente as 6 colunas do seu cadastro original
                      String novaLinhaProd = dadosPedP[0] + ";" + dadosPedP[1] + ";" + dadosPedP[2] + ";" +
                          dadosPedP[3] + ";" + dadosPedP[4] + ";" + dadosPedP[5];
                    ...
                    System.out.println(
                        "Item \"" + nomeProduto + "\" adicionado ao pedido com sucesso! Subtotal: R$ "
                            + valorTotalItem);
                  }
                ...
                System.out.println(menu("PEDIDO FINALIZADO PARA O CLIENTE CPF: " + cpfCliente));
                break;
